...
import { getInventory, stockIn, stockOut, getSerials, searchSerials, updateSerial, deleteSerial, serialLookup } from '../controllers/inventory';
...
router.get('/serial-lookup', requirePermission('inventory:view'), serialLookup);
